                  ...
                  <CardContent className='flex md:flex-row flex-col gap-5'>
                    ...
                    <div className='flex flex-col gap-2'>
                      ...
                      <CardDescription className='flex flex-col'>
                        ...
                        <span className='justify-center gap-2 flex-col mt-10 md:text-lg text-md flex items-center space-x-2'>
                          ...
                          <time className='flex items-center space-x-1'>
                            {auctionEnded ? (
                              ...
                              <>
                                <span className='md:text-2xl text-lg bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-200 py-2 px-3 rounded-lg'>
